...
// final FirebaseFirestore _store = FirebaseFirestore.instance;
// Stream<QuerySnapshot<Map<String, dynamic>>> getUsers =
//     _store.collection("users").doc(_auth.currentUser!.uid).collection("contactList").snapshots();
...
//                       snapshot.data!.docs.map((doc) => doc.data()).toList();
//                   contacts.firstWhere(
//                     (element) => _auth.currentUser!.uid == element["uid"],
//                   );
//                   return ListView.builder(
//                     itemCount: contacts.length,
//                     itemBuilder: (context, index) {
//                       log(contacts[index]["uid"]);
//                       final List contact = contacts[index]["contacts"];
//                       return contact.length != 0
//                           ? Container(height: mediaqueryHight(.9, context),width:mediaqueryWidth(10, context),
